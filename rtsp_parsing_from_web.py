...
ip = "192.168.1.209" # IP address of your cam
id = "root"
pw = "pass"
streamname = "ufirststream"
adr = "rtsp://%s:%s@%s/%s" %(id, pw, ip,streamname) # username, passwd, etc.
adrs = "rtsp://%s:%s@%s" %(id, pw, ip) # username, passwd, etc.
...
dest = ("DESCRIBE %s RTSP/1.0\r\nCSeq: 2\r\nUser-Agent: python\r\nAccept: application/sdp\r\n\r\n" %adr).encode()
setu = ("SETUP %s/trackID=0 RTSP/1.0\r\nCSeq: 3\r\nUser-Agent: python\r\nTransport: RTP/AVP;unicast;client_port=%d-%d\r\n\r\n" %(adr, clientports[0], clientports[1])).encode()
play="PLAY "+adr+" RTSP/1.0\r\nCSeq: 5\r\nUser-Agent: python\r\nSession: SESID\r\nRange: npt=0.000-\r\n\r\n"
